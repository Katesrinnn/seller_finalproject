...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
        appBar: AppBar(
          title: boldText(text: editProfile, color: fontBlack, size: 16.0),
          actions: [
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                10.heightBox,
                ElevatedButton(
                    style: ElevatedButton.styleFrom(backgroundColor: primaryApp),
                    onPressed: () {
                ...
                Align(
                  ...
                  child:
                      boldText(text: "Change your password", color: fontGreyDark),
                ),
                10.heightBox,
                customTextField(
                ...
                10.heightBox,
                customTextField(
                    label: confirmPass, controller: controller.newpassController),
                10.heightBox,
