...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var bottomNavbar = [
      BottomNavigationBarItem(icon: Image.asset(icHome, color: fontGrey, width: 22,), label: dashboard),
      BottomNavigationBarItem(icon: Image.asset(icProducts, color: fontGrey, width: 22,), label: products),
      BottomNavigationBarItem(icon: Image.asset(icOrders, color: fontGrey, width: 22,), label: orders),
      BottomNavigationBarItem(icon: Image.asset(icGeneralSettings, color: fontGrey, width: 22,), label: settings),
    ];
